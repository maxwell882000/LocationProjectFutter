...
import 'package:location_specialist/pages/payment/widgets/fail_payment.dart';
import 'package:location_specialist/pages/payment/widgets/payment.dart';
import 'package:location_specialist/pages/payment/widgets/success_payment.dart';
...
import 'package:location_specialist/pages/specialist/components/test_multiple.dart';
import 'package:location_specialist/routes/path.dart';

import '../pages/payment/widgets/waiting_payment.dart';

class Routes {
  static const INITIAL = Path.INITIAL;
  static final routes = [
    GetPage(page: () => MainScreen(), name: Path.DYNAMIC),
    ...
    GetPage(name: Path.PAYMENT, page: () => Payment(), middlewares: []),
    GetPage(name: Path.SALES_TEXT, page: () => SaleTextView()),
    GetPage(name: Path.FORGET_PASSWORD, page: () => ForgetPassword()),
    GetPage(name: Path.INSTRUCTIONS, page: () => InstructionsView()),
    GetPage(
