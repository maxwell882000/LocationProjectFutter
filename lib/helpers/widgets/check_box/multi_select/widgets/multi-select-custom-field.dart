...
import 'multi-select-custom.dart';

/// A customizable InkWell widget that opens the MultiSelectDialog
// ignore: must_be_immutable
class MultiSelectCustomField<V> extends FormField<List<V>> {
  ...
  final Widget? title;
  final List<MultiSelectItem<V>> Function(MultiSelectCustom object, String? val,
      List<MultiSelectItem<V>> allItems)? onSearchStarted;
...
class _MultiSelectDialogFieldView<V> extends StatefulWidget {
  ...
  _MultiSelectDialogFieldView._withState(
      ...
      : items = field.items,
        ...
        onSearchStarted = field.onSearchStarted,
